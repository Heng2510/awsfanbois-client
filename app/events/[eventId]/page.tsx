            ...
            <div className="mb-6 md:mb-0 ml-8 mt-6">
              ...
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 mt-3">
                <span className="mb-3 font-light text-green-bg text-xl">
                  202 Đ. Hoàng Văn Thụ, Phường 9, Quận Phú Nhuận, Thành Phố Hồ
                  Chí Minh
                </span>
              </p>
            </div>
              ...
              <AccordionPanel>
                ...
                <AccordionContent>
                  <p className="mb-2 text-green-bg text-lg">
                    Điều khoản và Điều kiện: Chương trình không dành cho trẻ em
                    từ 5 tuổi trở xuống. Term and Conditions: No admission for
